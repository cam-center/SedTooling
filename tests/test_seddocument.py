...
def test_create() -> None:
    ...
    dependency = Dependency(name="depname", identifier="depid", type="org1::mytype", source="mysource")
    constant1 = Constant(name="const1", identifier="const1id", type="org1::mytype", value="const1value")
    constant2 = Constant(name="const2", identifier="const2id", type="org1::mytype", value="const2value")
